...
(function ($) {
    ...
    $.fn.fileinputLocales['zh'] = {
        ...
        msgFilesTooLess: '你必须选择最少 <b>{n}</b> {upload} 来上传. ',
        ...
        msgLoading: '加载第 {index} 文件 共 {upload} &hellip;',
        msgProgress: '加载第 {index} 文件 共 {upload} - {name} - {percent}% 完成.',
        msgSelected: '{n} {upload} 选中',
