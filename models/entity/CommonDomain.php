...
require_once __DIR__.'/../../commons/MappingTables/Common.php';
class CommonDomain
{
    private $cdashTable;
    private $odmTable;
    ...
    {
        $fileName = "../../mapfiles/Common_MAP.csv";
        $common = new Common();

        if(!file_exists($fileName)) {

            $this->cdashTable = $common->getCdashTable();
            $this->odmTable = $common->getOdmTable();
